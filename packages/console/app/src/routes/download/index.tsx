          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button
                ...
                onClick={handleCopyClick("curl -fsSL https://costrict.ai/install | bash")}
              >
                <code>
                  curl -fsSL https://<strong>costrict.ai/install</strong> | bash
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("npm i -g costrict-ai")}>
                <code>
                  npm i -g <strong>costrict-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("bun add -g costrict-ai")}>
                <code>
                  bun add -g <strong>costrict-ai</strong>
                </code>
                <CopyStatus />
              </button>
              ...
              <button data-component="cli-row" onClick={handleCopyClick("paru -S costrict-cli")}>
                <code>
                  paru -S <strong>costrict-cli</strong>
                </code>
                <CopyStatus />
              </button>
            </div>
