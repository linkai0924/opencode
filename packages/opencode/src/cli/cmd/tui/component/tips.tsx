...
const TIPS = [
  ...
  "Create {highlight}costrict.json{/highlight} in project root for project-specific settings",
  "Place settings in {highlight}~/.config/costrict/costrict.json{/highlight} for global config",
  ...
  "Use {highlight}cs run{/highlight} for non-interactive scripting",
  "Use {highlight}cs run --continue{/highlight} to resume the last session",
  "Use {highlight}cs run -f file.ts{/highlight} to attach files via CLI",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "Run {highlight}cs serve{/highlight} for headless API access to CoStrict",
  "Use {highlight}cs run --attach{/highlight} to connect to a running server",
  ...
  "Run {highlight}cs github install{/highlight} to set up the GitHub workflow",
  "Comment {highlight}/cs fix this{/highlight} on issues to auto-create PRs",
  ...
  "Run {highlight}cs debug config{/highlight} to troubleshoot configuration",
