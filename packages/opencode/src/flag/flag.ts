...
export namespace Flag {
  ...
  export const COSTRICT_ENABLE_OPENCODE_CONFIG =
    process.env.COSTRICT_ENABLE_OPENCODE_CONFIG === undefined ? false : truthy("COSTRICT_ENABLE_OPENCODE_CONFIG")
  ...
  export const COSTRICT_ENABLE_DEFAULT_PLUGINS = truthy("COSTRICT_ENABLE_DEFAULT_PLUGINS")
  ...
  export const COSTRICT_DISABLE_MODELS_FETCH =
    process.env.COSTRICT_DISABLE_MODELS_FETCH === undefined ? true : truthy("COSTRICT_DISABLE_MODELS_FETCH")
  ...
  export const COSTRICT_ENABLE_INSTALL_DEPENDENCIES = truthy("COSTRICT_ENABLE_INSTALL_DEPENDENCIES")
  ...
  export const OPENCODE_ENABLE_DEFAULT_PLUGINS = truthy("OPENCODE_ENABLE_DEFAULT_PLUGINS")
