...
Create `.costrict-cli/command/test.md`:

```md title=".costrict-cli/command/test.md"
---
...
You can add custom commands through the CoStrict config or by creating markdown files in the `command/` directory.

---

### JSON

Use the `command` option in your CoStrict [config](/docs/config):
...
- Global: `~/.config/costrict-cli/command/`
- Per-project: `.costrict-cli/command/`

```markdown title="~/.config/costrict-cli/command/test.md"
---
description: Run tests with coverage
agent: build
model: anthropic/claude-3-5-sonnet-20241022
...
```md title=".costrict-cli/command/component.md"
---
...
```md title=".costrict-cli/command/create-file.md"
---
...
```md title=".costrict-cli/command/analyze-coverage.md"
---
...
```md title=".costrict-cli/command/review-changes.md"
---
...
```md title=".costrict-cli/command/review-component.md"
---
...
costrict-cli includes several built-in commands like `/init`, `/undo`, `/redo`, `/share`, `/help`; [learn more](/docs/tui#commands).
