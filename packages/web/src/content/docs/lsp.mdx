---
title: LSP Servers
description: CoStrict integrates with your LSP servers.
---

CoStrict integrates with your Language Server Protocol (LSP) to help the LLM interact with your codebase. It uses diagnostics to provide feedback to the LLM.

---

## Built-in

CoStrict comes with several built-in LSP servers for popular languages:
...
When costrict-cli opens a file, it:
...
You can customize LSP servers through the `lsp` section in your costrict-cli config.
